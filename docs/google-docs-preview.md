...
`preview`, sans le déduire d'un état extérieur à la revue. Les surcharges
TypeScript conservent aussi le mode connu depuis l'option `preserveStyles`
jusqu'au résultat de la validation.
